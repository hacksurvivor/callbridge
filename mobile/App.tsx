  ...
  return (
    <View style={styles.app}>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.content}>
        <View style={styles.brandRow}><Text style={styles.wordmark}>CallBridge</Text><Text style={styles.mode}>{isConvexConfigured ? "Connected" : "Local preview"}</Text></View>
        ...
        {stage === "active" && task && <Active task={task} onResult={() => { setTask(taskStore.prepareDecision()); advance("decision"); }} onStop={() => setTask(taskStore.stopCurrent())} />}
