...
const StreamingTextPart: TextMessagePartComponent = ({ text, status }) => {
  ...
  return (
    <StreamingText
      ...
      count={count}
      streaming
      className="min-h-0 max-w-none text-base leading-relaxed"
    />
  );
};
          ...
          {({ part, children }) => {
            switch (part.type) {
              ...
              case "source":
                return <Sources {...part} />;
              case "indicator":
                return <ThinkingIndicator label="Thinking" className="py-1" aria-label="Assistant is working" />;
              default:
                return null;
            }
          }}
