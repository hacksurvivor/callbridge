...
const toolDisplayName = (toolName: string) => {
  const callBridgeNames: Record<string, string> = {
    read_call_draft: "Read call draft",
    update_call_draft: "Update call draft",
    prepare_confirmation: "Prepare confirmation",
    get_inquiry_result: "Check call result",
  };
  return callBridgeNames[toolName]
...
function ToolFallbackTrigger({
  ...
  return (
    ...
    >
      ...
      >
        {label}: <b>{toolDisplayName(toolName)}</b>
      </span>
